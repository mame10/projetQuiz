...
<body>
<div class="head">
    <div class="icon"><img src="<?= PATH_PUBLIC."img".DIRECTORY_SEPARATOR."logo-QuizzSA.png"?>"></img></div>
    <div class="txt"><h2>Le plaisir de jouer</h2></div>
</div>
 <div id="container">
        ...
        <form action="<?= WEBROOT . "?controller=securite&action=connexion" ?>" method="POST">
            ...
            <input type="text" placeholder="Entrer le nom d'utilisateur" name="login" id="email">
